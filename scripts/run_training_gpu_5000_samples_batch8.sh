#!/bin/bash
#SBATCH --job-name=send_training_5k_b8
...
echo "=== Starting Training on 5000 SAMPLES with 100 EPOCHS ==="
...
LOG_FILE="logs/training_5000_samples_gpu_batch8_$(date +%Y%m%d_%H%M%S).log"
