#!/bin/bash
#SBATCH --job-name=send_training_full_b4
...
#SBATCH --output=training_full_dataset_gpu_batch4_%j.out
#SBATCH --error=training_full_dataset_gpu_batch4_%j.err
...
LOG_FILE="logs/training_full_dataset_gpu_batch4_$(date +%Y%m%d_%H%M%S).log"
