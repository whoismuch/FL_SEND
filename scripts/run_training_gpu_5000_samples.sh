#!/bin/bash
#SBATCH --job-name=send_training_5000
...
#SBATCH --output=training_5000_samples_gpu_%j.out
#SBATCH --error=training_5000_samples_gpu_%j.err
...
LOG_FILE="logs/training_5000_samples_gpu_$(date +%Y%m%d_%H%M%S).log"
