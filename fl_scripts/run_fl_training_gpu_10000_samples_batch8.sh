#!/bin/bash
#SBATCH --job-name=fl_send_training_10k_b8
...
#SBATCH --output=fl_training_10000_samples_gpu_batch8_%j.out
#SBATCH --error=fl_training_10000_samples_gpu_batch8_%j.err
...
echo "=== Starting Federated Learning Training on 10000 SAMPLES ==="
...
LOG_FILE="logs/fl_training_10000_samples_gpu_batch8_$(date +%Y%m%d_%H%M%S).log"
