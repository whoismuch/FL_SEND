#!/bin/bash
#SBATCH --job-name=fl_send_training_5k_b8
#SBATCH --time=7-00:00:00  # 7 days (should be enough for 5000 samples)
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=fl_training_5000_samples_gpu_batch8_%j.out
#SBATCH --error=fl_training_5000_samples_gpu_batch8_%j.err
...
echo "=== Starting Federated Learning Training on 5000 SAMPLES ==="
...
LOG_FILE="logs/fl_training_5000_samples_gpu_batch8_$(date +%Y%m%d_%H%M%S).log"
...
# Using --test_size 5000 to limit dataset to 5000 samples
